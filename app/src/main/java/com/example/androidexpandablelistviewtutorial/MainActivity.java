package com.example.androidexpandablelistviewtutorial;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        //THIS SECTION DEALS ONLY WITH THE SPINNER, I DON'T CARE.
        ...
        //expand all Groups - Only at the beginning.
        expandAll();
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            //This function matters only for ADDING. It is irrelevant to everything else.
    ...
    private void expandAll() {
        System.out.println("Expand All function, if used, comes here.");
    ...
    private void collapseAll() {
        System.out.println("I used this when it came time to collapse the group only for fucking ADD");
        int count = listAdapter.getGroupCount();
        for (int i = 0; i < count; i++){
    ...
    //our child listener - Listens if Child is Clicked
    private ExpandableListView.OnChildClickListener myListItemClicked =  new ExpandableListView.OnChildClickListener() {

        public boolean onChildClick(ExpandableListView parent, View v,
                                    int groupPosition, int childPosition, long id) {
            System.out.println("When I clicked on the child it came here, proving it isn't the clicking");
    ...
    //our group listener - Listens if Group is clicked
    private ExpandableListView.OnGroupClickListener myListGroupClicked =  new ExpandableListView.OnGroupClickListener() {
        ...
        public boolean onGroupClick(ExpandableListView parent, View v,
            ...
            System.out.println("When I collapse the group, it came to here.");

            //get the group header - Because it indicates which group has been clicked, he's just calling it so that he can do headerInfo.getname.//I still cannot find where the fucking expansion takes place.
            HeaderInfo headerInfo = SectionList.get(groupPosition);
            //display it or do something with it
